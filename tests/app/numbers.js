...
describe('numbers', function() {
  describe('binary operations', function() {
   xit('you should be able to find the value of a given bit', function() {
   ...
   xit('you should be able to return the base10 representation of a binary string', function() {
  ...
  describe('decimals', function() {
   xit('you should be able to multiply with precision', function() {
